...
let numberOfWord = str3.match(pattern2)
console.log("word love appears " +numberOfWord.length+ " times")


//Use match() to count the number of all because in the following sentence:'You cannot end a sentence with because because because is a conjunction'
const str4 = 'You cannot end a sentence with because because because is a conjunction'
let pattern3 = /because/gi
let numberOfWord2 = str4.match(pattern3)
console.log("because appears " + numberOfWord2.length + " times")
